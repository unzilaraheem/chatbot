...
# ⚡ Ultra-Fast AI Ad Expert v4.0 — Single Gemini Call, No Delays
...
# Inputs
campaign = input("👋 Hello! I'm your AI Ad Expert.\n🎯 Choose your Campaign Type (Awareness / Engagement / Sales): ").strip().lower()
...
# ✅ SINGLE FAST API CALL — Generates AD PLAN + POSTER REVIEW in one call
prompt = f"""
...
1️⃣ First, give this in EXACT format:
...
2️⃣ Then, if poster provided, analyze it in exactly 4 lines:
✔ Good: (1 point)
⚙ Improve: (1 point)
🎯 Why: (1 reason)
🎨 Color Tip: (1 suggestion)
